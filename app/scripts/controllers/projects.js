...
.controller('projectsController', function(){
    ...
    projectsList.data =[{
        ...
        title:'Flickr Search', image:'/images/projects/flickrsearch.png', github: 'https://github.com/mlamont8/flickrSearch', desc: 'Using Yeoman Angular as a starting point, this AngularJS app was built using the API from Flickr.com.  This app provides search results for user submitted search terms.  For CSS, Angular Material was used with SASS. The Angular Grid module was used to bring a masonry experience with the results.', link: 'https://simple-flickr-search.firebaseapp.com/', tech:'AngularJS, HTML, Angular Material'
    },{
